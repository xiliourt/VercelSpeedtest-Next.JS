...
const SERVERS = [
    ...
    { name: 'Fly.io (Docker)', pingUrl: 'https://vercelspeedtest-next-js.fly.dev/api/ping', downloadUrl: 'https://vercelspeedtest-next-js.fly.dev/api/download', uploadUrl: 'https://vercelspeedtest-next-js.fly.dev/api/upload', maxUpload: '107374182400' },
